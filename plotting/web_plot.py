...
diagnostic_plots.star_plot(axs[0], targ_ra, targ_dec, data, iso, g_radius, nbhd)
diagnostic_plots.density_plot(axs[1], targ_ra, targ_dec, data, iso, g_radius, nbhd, 'stars')
diagnostic_plots.density_plot(axs[2], targ_ra, targ_dec, data, iso, g_radius, nbhd, 'galaxies')
diagnostic_plots.cm_plot(axs[3], targ_ra, targ_dec, data, iso, g_radius, nbhd, 'stars')
diagnostic_plots.hess_plot(axs[4], targ_ra, targ_dec, data, iso, g_radius, nbhd)
